...
MET_SSPM_RTS_EVNET(SSPM_CM_MGR_DSU_DVFS_PWR, "up_L,up_B,up_DSU,cur_L,cur_B,cur_DSU,down_L,down_B,down_DSU,total_up,total_cur,total_down")
MET_SSPM_RTS_EVNET(SSPM_CM_MGR_DSU_DVFS_ACT_STALL_PWR, "up_L_a,up_B_a,cur_L_a,cur_B_a,down_L_a,down_B_a,up_L_s,up_B_s,cur_L_s,cur_B_s,down_L_s,down_B_s")
MET_SSPM_RTS_EVNET(SSPM_CM_MGR_DSU_DVFS_STALL, "cpu0,cpu1,cpu2,cpu3,cpu4,cpu5,cpu6,cpu7,l3_bw_val")
MET_SSPM_RTS_EVNET(SSPM_CM_MGR_DSU_DVFS_ACTIVE, "cpu0,cpu1,cpu2,cpu3,cpu4,cpu5,cpu6,cpu7")
MET_SSPM_RTS_EVNET(SSPM_CM_MGR_DSU_DVFS_OPP, "map_opp_50,map_opp_70,final,orig,L3_vote_opp,debounce_up,debounce_down")
MET_SSPM_RTS_EVNET(SSPM_CM_MGR_DSU_DVFS_THRESHOLD_FLAG, "up_L,up_B,down_L,down_B,up_L_flag,up_B_flag,down_L_flag,down_B_flag")
...
MET_SSPM_RTS_EVNET(SSPM_SWPM_CPU__LKG_POWER, "cpu_L,cpu_B,dsu,thermal_cpu_L,thermal_cpu_B,thermal_dsu")
...
MET_SSPM_RTS_EVNET(SSPM_SWPM_DRAM__MEM_IDX, "read_bw,write_bw,srr_pct,pdir_pct,phr_pct,acc_util,trans,ddr_ratio,index_in_us,mr4,ddr_freq")
